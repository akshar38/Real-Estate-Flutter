...
class HostelPGDetail extends StatefulWidget {
  final String category;

  static String id = 'detail';
  HostelPGDetail({Key? key, required this.category}) : super(key: key);
  _HostelPGDetail createState() => _HostelPGDetail();
}

final _format = NumberFormat('##,##,##,##0');

class _HostelPGDetail extends State<HostelPGDetail> {
  @override
                              ...
                              children: [
                                ...
                                if (data['category'] == 'Hostel')
                                  Container(
                                    ...
                                    child: HostelAllDetail(data: data),
                                  ),
                                if (data['category'] == 'PG')
                                  Container(
                                    height: 195,
